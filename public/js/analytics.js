    ...
    <table class="w-full text-xs border-collapse">
      <thead class="bg-gray-50 text-xs uppercase sticky top-0 z-10">
        ...
        <tr class="border-b-2 border-gray-300">
          <th rowspan="2" class="px-2 py-2 border-r" style="min-width: 40px;">NO.</th>
          <th colspan="8" class="px-2 py-2 border-r bg-blue-100">발주 정보</th>
          <th colspan="${productionHeaders.length}" class="px-2 py-2 border-r bg-green-100">생산 공정 (일)</th>
          <th colspan="${shippingHeaders.length}" class="px-2 py-2 border-r bg-yellow-100">운송 상황 (일)</th>
          <th colspan="2" class="px-2 py-2 bg-purple-100">최종 현황</th>
        </tr>
        
        <!-- 서브 헤더 -->
        <tr class="border-b-2 border-gray-300">
          <!-- 발주 정보 -->
          <th class="px-2 py-2 border-r bg-blue-100" style="min-width: 60px;">채널</th>
          <th class="px-2 py-2 border-r bg-blue-100" style="min-width: 80px;">생산업체</th>
          <th class="px-2 py-2 border-r bg-blue-100" style="min-width: 100px;">스타일</th>
          <th class="px-2 py-2 border-r bg-blue-100" style="min-width: 50px;">색상</th>
          <th class="px-2 py-2 border-r bg-blue-100" style="min-width: 50px;">사이즈</th>
          <th class="px-2 py-2 border-r bg-blue-100" style="min-width: 60px;">수량</th>
          <th class="px-2 py-2 border-r bg-blue-100" style="min-width: 90px;">발주일</th>
          <th class="px-2 py-2 border-r bg-blue-100" style="min-width: 90px;">입고요구일</th>
          
          <!-- 생산 공정 -->
          ${productionHeaders.map(name => `
            <th class="px-2 py-2 border-r bg-green-100" style="min-width: 70px;">${name}</th>
          `).join('')}
          
          <!-- 운송 상황 -->
          ${shippingHeaders.map(name => `
            <th class="px-2 py-2 border-r bg-yellow-100" style="min-width: 70px;">${name}</th>
          `).join('')}
          
          <!-- 최종 현황 -->
          <th class="px-2 py-2 border-r bg-purple-100" style="min-width: 80px;">최종<br>지연일수</th>
          <th class="px-2 py-2 bg-purple-100" style="min-width: 90px;">물류입고<br>예정일</th>
        </tr>
      </thead>
      <tbody>
